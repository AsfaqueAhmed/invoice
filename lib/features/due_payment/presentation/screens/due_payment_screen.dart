...
import '../providers/due_payment_provider.dart';

class DuePaymentScreen extends ConsumerWidget {
  const DuePaymentScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final colors = context.appColors;
    final selectedFilter = ref.watch(selectedDuePaymentFilterProvider);
    final payments = ref.watch(duePaymentsProvider);
      ...
      body: CustomScrollView(slivers: [
        SliverAppBar(
          ...
          actions: [
            IconButton(
              icon:
                  Icon(Icons.notifications_outlined, color: colors.outline),
              onPressed: () {},
            ),
          ],
        ),
            ...
            child: Column(children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: duePaymentFilters.map((f) {
                    final active = selectedFilter == f;
                    return Padding(
                      padding: const EdgeInsets.only(right: 8),
                      child: GestureDetector(
                        onTap: () => ref
                            .read(selectedDuePaymentFilterProvider.notifier)
                            .state = f,
              ...
              Column(
                children: payments.map((p) {
                  ...
                  return Padding(
                    ...
                    child: AppCard(
                      color: isOverdue
                          ? colors.chipRedBg.withValues(alpha: 0.5)
                          : null,
                      child: Column(children: [
                        Row(
                            ...
                            Expanded(
                              child: Row(children: [
                                Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      (p['name'] as String).substring(0, 2),
                                      style: TextStyle(
                                        fontWeight: FontWeight.w700,
                                        color: colors.primary,
                                      ),
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () => onCollectDuePayment(p),
