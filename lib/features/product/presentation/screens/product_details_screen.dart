...
class ProductDetailsScreen extends StatelessWidget {
  ...
  String get _status {
    if (_product.stock == 0) return 'outofstock';
    if (_product.stock <= 10) return 'lowstock';
    return 'instock';
  }

  void _onEdit() => Get.toNamed(Routes.ADD_PRODUCT, arguments: _product);

  void _onAddToInvoice() => Get.toNamed(Routes.createInvoice);
