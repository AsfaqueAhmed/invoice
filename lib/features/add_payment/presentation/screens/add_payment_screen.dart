...
import '../providers/add_payment_provider.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton.icon(
          onPressed: state.isSaving ? null : notifier.onConfirm,
          icon: state.isSaving
              ? const SizedBox(
                  width: 18,
                  height: 18,
          ...
          label: Text(state.isSaving ? 'Saving...' : 'Confirm Payment'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          Wrap(
            spacing: 10,
            runSpacing: 10,
            children: addPaymentMethods.map((m) {
              final active = state.selectedMethod == m['label'];
              return GestureDetector(
                onTap: () => notifier.selectMethod(m['label'] as String),
