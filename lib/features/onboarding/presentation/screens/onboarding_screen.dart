      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              Expanded(
                child: _IllustrationSection(colors: colors),
              ),
              AnimatedBuilder(
              ...
              AnimatedBuilder(
                ...
                builder: (context, _) => FadeTransition(
                  ...
                  child: SlideTransition(
                    position: _slideAnimation,
                    child: _CtaSection(colors: colors),
                  ),
                ),
              ),
              Gaps.v16,
...
class _CtaSection extends ConsumerWidget {
  final AppColorBase colors;
  const _CtaSection({required this.colors});
      ...
      children: [
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed:
                state.isPrimaryLoading ? null : notifier.onStartBusiness,
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            onPressed:
                state.isSecondaryLoading ? null : notifier.onRestoreBackup,
            ...
            child: state.isSecondaryLoading
                ? SizedBox(
                    width: 22,
                    height: 22,
                    child: CircularProgressIndicator(
