...
import '../../../business_setup/domain/entities/business_entity.dart';
...
class SettingsScreen extends ConsumerWidget {
  ...
  Future<void> _onEditBusiness(
      WidgetRef ref, List<BusinessEntity> businesses) async {
    final result = await Get.toNamed(
      Routes.businessSetup,
      arguments: businesses.first,
    );
    if (result == true) {
              ...
              children: [
                ...
                AppCard(
                  child: _SettingsTile(
                    ...
                    colors: colors,
                    onTap: businesses.isEmpty
                        ? () {}
                        : () => _onEditBusiness(ref, businesses),
                  ),
                ),
