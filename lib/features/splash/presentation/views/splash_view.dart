    ...
    return Stack(
      children: [
        Positioned(
          ...
          left: 40,
          child: _Dot(size: 8, color: colors.primary.withOpacity(0.2)),
        ),
        Positioned(
          bottom: MediaQuery.of(context).size.height * 0.33,
          right: 48,
          child: _Dot(size: 12, color: colors.secondary.withOpacity(0.15)),
        ),
        Positioned(
          top: MediaQuery.of(context).size.height * 0.15,
          right: 80,
          child: _Dot(size: 6, color: colors.primary.withOpacity(0.1)),
        ),
      ],
    );
  }
